...
void dbt::AOSIROpt::populateFuncPassManager(llvm::legacy::FunctionPassManager* FPM, 
...
void dbt::AOSIROpt::optimizeIRFunction(llvm::Module* Mod, std::vector<uint16_t> Opts, OptLevel Level) {

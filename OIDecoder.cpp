...
constexpr uint8_t getCount(Word W) { return (W.asI_) & 0xFF; }

constexpr uint8_t getIndex(Word W) { return (W.asI_ >> 8) & 0x3F; }

constexpr uint16_t getPL12(Word W) { return (W.asI_ >> 14) & 0xFFF; }

constexpr uint8_t getRS(Word W) { return (W.asI_ >> 6) & 0x3F; }

constexpr uint8_t getRT(Word W) { return W.asI_ & 0x3F; }

constexpr uint8_t getRD(Word W) { return (W.asI_ >> 12) & 0x3F; }

constexpr uint8_t getRV(Word W) { return (W.asI_ >> 18) & 0x3F; }
...
constexpr uint32_t getPL18(Word W) { return W.asI_ & 0x3FFFF; }

constexpr uint32_t getAddr(Word W) { return W.asI_ & 0xFFFFF; }

constexpr uint32_t getLAddr(Word W) { return W.asI_ & 0x3FFFFFF; }
...
extern void dbt::OIDecoder::fillFields(OIInst &I, EncodingType E, Word W) {
  ...
  case EncodingType::PL0:
    break;
  default:
    std::cout << "It may seem unbelievable, but we haven't implemented this "
                 "encoding type!\n";
    break;
  }
}
...
OIInst dbt::OIDecoder::decode(uint32_t CodedInst) {
  ...
  case 0b100010:
    ...
    if (Ext == 0b0)
      I.Type = OIInstType::Callr;
    if (Ext == 0b11)
      I.Type = OIInstType::Seb;
    if (Ext == 0b100)
      I.Type = OIInstType::Seh;
    if (Ext == 0b101)
      I.Type = OIInstType::Absd;
    if (Ext == 0b110)
      I.Type = OIInstType::Abss;
    if (Ext == 0b111)
      I.Type = OIInstType::Ceqd;
    if (Ext == 0b1000)
      I.Type = OIInstType::Ceqs;
    if (Ext == 0b1001)
      I.Type = OIInstType::Coled;
    if (Ext == 0b1010)
      I.Type = OIInstType::Coles;
    if (Ext == 0b1011)
      I.Type = OIInstType::Coltd;
    if (Ext == 0b1100)
      I.Type = OIInstType::Colts;
    if (Ext == 0b1101)
      I.Type = OIInstType::Cueqd;
    if (Ext == 0b1111)
      I.Type = OIInstType::Culed;
    if (Ext == 0b10000)
      I.Type = OIInstType::Cules;
    if (Ext == 0b10001)
      I.Type = OIInstType::Cultd;
    if (Ext == 0b10010)
      I.Type = OIInstType::Cults;
    if (Ext == 0b10011)
      I.Type = OIInstType::Cund;
    if (Ext == 0b10100)
      I.Type = OIInstType::Cuns;
    if (Ext == 0b10101)
      I.Type = OIInstType::Cvtsd;
    if (Ext == 0b10110)
      I.Type = OIInstType::Cvtds;
    if (Ext == 0b10111)
      I.Type = OIInstType::Cvtdw;
    if (Ext == 0b11000)
      I.Type = OIInstType::Cvtsw;
    if (Ext == 0b11001)
      I.Type = OIInstType::Mfc1;
    if (Ext == 0b11010)
      I.Type = OIInstType::Movd;
    if (Ext == 0b11011)
      I.Type = OIInstType::Movs;
    if (Ext == 0b11100)
      I.Type = OIInstType::Mtc1;
    if (Ext == 0b11101)
      I.Type = OIInstType::Negd;
    if (Ext == 0b11110)
      I.Type = OIInstType::Negs;
    if (Ext == 0b11111)
      I.Type = OIInstType::Truncwd;
    if (Ext == 0b100000)
      I.Type = OIInstType::Truncws;
    if (Ext == 0b100001)
      I.Type = OIInstType::Sqrtd;
    if (Ext == 0b100010)
      I.Type = OIInstType::Sqrts;
    if (Ext == 0b100011)
      I.Type = OIInstType::Movtd;
    if (Ext == 0b100101)
      I.Type = OIInstType::Movfd;
    if (Ext == 0b100110)
      I.Type = OIInstType::Movfs;
    if (Ext == 0b100111)
      I.Type = OIInstType::Movf;
    if (Ext == 0b101000)
      I.Type = OIInstType::Movt;
    if (Ext == 0b100100)
      I.Type = OIInstType::Movts;
    if (Ext == 0b101001)
      I.Type = OIInstType::Mfhc1;
    if (Ext == 0b101010)
      I.Type = OIInstType::Mthc1;
    if (Ext == 0b110001)
      I.Type = OIInstType::Mflc1;
    if (Ext == 0b110010)
      I.Type = OIInstType::Mtlc1;
    break;
  case 0b100000:
    Ext = (W.asI_ & OpMask) >> 18;
    if (Ext == 0b0)
      I.Type = OIInstType::Add;
    if (Ext == 0b1)
      I.Type = OIInstType::Ldihi;
    if (Ext == 0b10)
      I.Type = OIInstType::Sub;
    if (Ext == 0b100)
      I.Type = OIInstType::Slt;
    if (Ext == 0b101)
      I.Type = OIInstType::Sltu;
    if (Ext == 0b110)
      I.Type = OIInstType::And;
    if (Ext == 0b111)
      I.Type = OIInstType::Or;
    if (Ext == 0b1000)
      I.Type = OIInstType::Xor;
    if (Ext == 0b1001)
      I.Type = OIInstType::Nor;
    if (Ext == 0b1010)
      I.Type = OIInstType::Shl;
    if (Ext == 0b1011)
      I.Type = OIInstType::Shr;
    if (Ext == 0b1100)
      I.Type = OIInstType::Asr;
    if (Ext == 0b1101)
      I.Type = OIInstType::Shlr;
    if (Ext == 0b1110)
      I.Type = OIInstType::Shrr;
    if (Ext == 0b1111)
      I.Type = OIInstType::Asrr;
    if (Ext == 0b10000)
      I.Type = OIInstType::Movz;
    if (Ext == 0b10001)
      I.Type = OIInstType::Movn;
    if (Ext == 0b10010)
      I.Type = OIInstType::Ror;
    if (Ext == 0b10100)
      I.Type = OIInstType::Addd;
    if (Ext == 0b10101)
      I.Type = OIInstType::Adds;
    if (Ext == 0b10110)
      I.Type = OIInstType::Divd;
    if (Ext == 0b10111)
      I.Type = OIInstType::Divs;
    if (Ext == 0b11000)
      I.Type = OIInstType::Muld;
    if (Ext == 0b11001)
      I.Type = OIInstType::Muls;
    if (Ext == 0b11010)
      I.Type = OIInstType::Subd;
    if (Ext == 0b11011)
      I.Type = OIInstType::Subs;
    if (Ext == 0b11100)
      I.Type = OIInstType::Movzd;
    if (Ext == 0b11101)
      I.Type = OIInstType::Movzs;
    if (Ext == 0b11110)
      I.Type = OIInstType::Movnd;
    if (Ext == 0b11111)
      I.Type = OIInstType::Movns;
    if (Ext == 0b100000)
      I.Type = OIInstType::Ldxc1;
    if (Ext == 0b100001)
      I.Type = OIInstType::Sdxc1;
    if (Ext == 0b100010)
      I.Type = OIInstType::Lwxc1;
    if (Ext == 0b100011)
      I.Type = OIInstType::Swxc1;
    break;
  case 0b100001:
    Ext = (W.asI_ & OpMask) >> 16;
    if (Ext == 0b0)
      I.Type = OIInstType::Bc1t;
    if (Ext == 0b10)
      I.Type = OIInstType::Bc1f;
    break;
  case 0b11110:
    Ext = (W.asI_ & OpMask) >> 24;
    if (Ext == 0b0)
      I.Type = OIInstType::Maddd;
    if (Ext == 0b01)
      I.Type = OIInstType::Madds;
    if (Ext == 0b10)
      I.Type = OIInstType::Msubd;
    if (Ext == 0b11)
      I.Type = OIInstType::Msubs;
    break;
  case 0b11111:
    Ext = (W.asI_ & OpMask) >> 20;
    if (Ext == 0b0)
      I.Type = OIInstType::Jlez;
    if (Ext == 0b1)
      I.Type = OIInstType::Jgtz;
    if (Ext == 0b10)
      I.Type = OIInstType::Jltz;
    if (Ext == 0b11)
      I.Type = OIInstType::Jgez;
    if (Ext == 0b100)
      I.Type = OIInstType::Ldi;
    if (Ext == 0b10000)
      I.Type = OIInstType::Ijmphi;
    break;
  ...
  if (I.Type == OIInstType::Null) {
    std::cout << "Houston: we have a problem! Inst (" << std::hex << CodedInst
              << ") not implemented! \n";
    exit(1);
  }
  ...
  if (!CallZero && I.Type == Call && (I.Addrs << 2) == 0) {
    std::cerr << "Pay attention! Something must have been linked wrongly, a "
                 "call 0 was found! Maybe a -lm missing?\n";
    CallZero = true;
  }
...
std::array<uint32_t, 2> dbt::OIDecoder::getPossibleTargets(uint32_t PC,
                                                           OIInst Inst) {
  switch (Inst.Type) {
